...
export const Route = createFileRoute("/recipe/$slug/flow-b")({
  ...
  head: ({ loaderData }) => {
    ...
    const title = `${loaderData.title} (step connector) — Recipes`;
...
function RecipeStepsPage() {
  ...
  return <RecipeRoute slug={slug} publicRecipe={Route.useLoaderData()} variant="steps" />;
}